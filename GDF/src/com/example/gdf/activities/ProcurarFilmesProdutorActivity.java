...
public class ProcurarFilmesProdutorActivity extends Activity{
	EditText produtor ;
	...
	private Button buscar;
	 ...
	 public void buscarFilme(){
		 ...
		 produtor = (EditText) findViewById(R.id.editText1);
		 Filmes fil = db.getFilme("produtor", produtor.getText().toString());
