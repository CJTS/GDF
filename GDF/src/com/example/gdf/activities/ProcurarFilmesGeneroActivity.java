...
public class ProcurarFilmesGeneroActivity extends Activity{
	EditText genero ;
	...
	private Button buscar;
	 ...
	 public void buscarFilme(){
		 ...
		 genero = (EditText) findViewById(R.id.editText1);
		 Filmes fil = db.getFilme("genero", genero.getText().toString());
