...
public class ProcurarFilmesDiretorActivity extends Activity{
	EditText diretor ;
	...
	private Button buscar;
	 ...
	 public void buscarFilme(){
		 ...
		 diretor = (EditText) findViewById(R.id.editText1);
		 Filmes fil = db.getFilme("diretor", diretor.getText().toString());
